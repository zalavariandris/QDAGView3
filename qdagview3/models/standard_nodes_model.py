...
@dataclass
class StandardGraphItem:
    values: List[str]
    parent: Optional["StandardGraphItem"] = None
    children: List["StandardGraphItem"] = field(default_factory=list)

    def child(self, row: int) -> Optional["StandardGraphItem"]:
    ...
    def insert_child(self, row: int, item: "StandardGraphItem") -> None:
        item.parent = self
...
class StandardNodesModel(QAbstractItemModel):
    def __init__(self, parent: Optional[QObject] = None) -> None:
        ...
        self._root = StandardGraphItem(values=["Root"])

    def _item_from_index(self, index: QModelIndex) -> StandardGraphItem:
        if index.isValid():
    ...
    def insertRows(self, row: int, count: int, parent: QModelIndex = QModelIndex()) -> bool:
        ...
        for offset in range(count):
            ...
            parent_item.insert_child(row + offset, StandardGraphItem(values=new_values, parent=parent_item))
        self.endInsertRows()
        return True
